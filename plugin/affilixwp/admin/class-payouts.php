...
class AffilixWP_Admin_Payouts {
    ...
    /**
     * Render Payout Management Screen
     */
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if ($row->status === 'pending'): ?>
                                <?php self::action_button($row->id, 'approve', 'Approve'); ?>
                            <?php elseif ($row->status === 'approved'): ?>
                                <?php self::action_button($row->id, 'pay', 'Mark Paid'); ?>
                            <?php endif; ?>
                        </td>
                    </tr>
                <?php endforeach; else: ?>
    ...
    private static function action_button($id, $action, $label) {
        ?>
